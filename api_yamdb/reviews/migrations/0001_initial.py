# Generated by Django 3.2 on 2023-05-24 16:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=128, unique=True, validators=[reviews.validators.validate_username, django.contrib.auth.validators.UnicodeUsernameValidator(regex='^[\\w.@+-]+\\Z')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(default=1, validators=[django.core.validators.MaxValueValidator(10, 'Не так много, max 10!'), django.core.validators.MinValueValidator(1, 'Хоть 1 поставь!')])),
